...
| dante | 122 | 5 | Y | dante_pitch | dante_pitch | Y |
| devon | 118 | 5 | Y | devon_logic | devon_logic | Y |
| isaiah | 118 | 5 | Y | isaiah_logistics | isaiah_logistics | Y |
| nadia | 114 | 4 | Y | nadia_news | nadia_news | Y |
...
| jordan | 98 | 16 | Y | jordan_structural | jordan_structural | Y |
...
- `condition_refs`: Nodes or choices with `requiredState` or `condition` gating.
