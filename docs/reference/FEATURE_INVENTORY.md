...
Generated: `2026-02-10T17:22:09.197Z` (commit `07fa57c41339`)
...
| Event | Documented | Used | Runtime | References |
| --- | --- | --- | --- | --- |
| `analytics:tracked` | YES | 0 | 0 |  |
| `game:arc:completed` | YES | 0 | 0 |  |
| `game:character:met` | YES | 0 | 0 |  |
| `game:choice:made` | YES | 0 | 0 |  |
| `game:cognitive:flow` | YES | 0 | 0 |  |
| `game:dialogue:completed` | YES | 0 | 0 |  |
| `game:dialogue:started` | YES | 0 | 0 |  |
| `game:emotional:calm` | YES | 0 | 0 |  |
| `game:emotional:stress` | YES | 0 | 0 |  |
| `game:golden_prompt:achieved` | YES | 0 | 0 |  |
| `game:interrupt:available` | YES | 0 | 0 |  |
| `game:interrupt:missed` | YES | 0 | 0 |  |
| `game:interrupt:taken` | YES | 0 | 0 |  |
| `game:knowledge:gained` | YES | 0 | 0 |  |
| `game:message:received` | YES | **1** | **1** | `hooks/useEventBus.ts` |
| `game:message:streaming` | YES | **1** | **1** | `hooks/useEventBus.ts` |
| `game:pattern:discovered` | YES | 0 | 0 |  |
| `game:pattern:threshold` | YES | 0 | 0 |  |
| `game:pattern:updated` | YES | 0 | 0 |  |
| `game:platform:updated` | YES | 0 | 0 |  |
| `game:presence:updated` | YES | **1** | **1** | `hooks/useEventBus.ts` |
| `game:relationship:updated` | YES | 0 | 0 |  |
| `game:scene:transition` | YES | **1** | **1** | `hooks/useEventBus.ts` |
| `game:simulation:completed` | YES | 0 | 0 |  |
| `game:simulation:started` | YES | 0 | 0 |  |
| `game:skill:unlocked` | YES | 0 | 0 |  |
| `game:skills:updated` | YES | 0 | 0 |  |
| `game:state:changed` | YES | **1** | **1** | `hooks/useEventBus.ts` |
| `game:trust:changed` | YES | **1** | **1** | `hooks/useEventBus.ts` |
| `game:vulnerability:revealed` | YES | 0 | 0 |  |
| `perf:api:slow` | YES | 0 | 0 |  |
| `perf:bundle:large` | YES | 0 | 0 |  |
| `perf:choice:slow` | YES | 0 | 0 |  |
| `perf:memory:warning` | YES | 0 | 0 |  |
| `perf:render:slow` | YES | 0 | 0 |  |
| `system:cleanup` | YES | 0 | 0 |  |
| `system:error` | YES | **1** | **1** | `hooks/useEventBus.ts` |
| `system:info` | YES | **1** | **1** | `hooks/useEventBus.ts` |
| `system:warning` | YES | **1** | **1** | `hooks/useEventBus.ts` |
| `ui:animation:complete` | YES | 0 | 0 |  |
| `ui:animation:start` | YES | 0 | 0 |  |
| `ui:error:hide` | YES | 0 | 0 |  |
| `ui:error:show` | YES | 0 | 0 |  |
| `ui:message:hide` | YES | **1** | **1** | `hooks/useEventBus.ts` |
| `ui:message:show` | YES | **1** | **1** | `hooks/useEventBus.ts` |
| `ui:modal:closed` | YES | 0 | 0 |  |
| `ui:modal:opened` | YES | 0 | 0 |  |
| `ui:notification:display` | YES | 0 | 0 |  |
| `ui:scene:hide` | YES | **1** | **1** | `hooks/useEventBus.ts` |
| `ui:scene:show` | YES | **1** | **1** | `hooks/useEventBus.ts` |
...
### Unknown Key Usages (Needs Review)

These are key registry identifiers found in code that are not present in `STORAGE_KEYS` / `DEV_STORAGE_KEYS` / `LEGACY_KEY_MAP`.
They are often from archived/legacy modules and may not be runtime bugs, but should be reviewed.
