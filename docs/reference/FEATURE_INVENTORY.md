...
Generated: `2026-02-10T18:10:00.984Z` (commit `063ee3167a99`)
...
Total: **46**
Unused (declared but not referenced): **19** (v2: **0**, dev: **0**, legacy: **19**)
...
### Unused Legacy Keys (Expected)

These keys exist only for migration from older builds and may not be referenced in current code.
