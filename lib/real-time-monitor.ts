...
class RealTimeMonitor {
   ...
   * Log Supabase sync
   */
  logSync(userId: string, syncType: 'career_analytics' | 'skill_summary' | 'skill_demonstration' | 'career_exploration', success: boolean, error?: string) {
    const activity: UserActivity = {
      timestamp: Date.now(),
      userId,
      activityType: 'sync',
...
export const logSync = (userId: string, syncType: 'career_analytics' | 'skill_summary' | 'skill_demonstration' | 'career_exploration', success: boolean, error?: string) =>
