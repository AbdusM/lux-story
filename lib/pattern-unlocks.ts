 ...
 *
 * NOTE: Descriptions are now framed as ACHIEVEMENTS (observations about who you are)
 * rather than PROMISES (gameplay features). This is intentional - unlocks don't
 * currently affect gameplay, they're markers of your journey.
 * See SIDE_MENUS_COMPREHENSIVE_AUDIT.md for context.
 */
export const PATTERN_UNLOCKS: PatternUnlock[] = [
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    description: "You've learned to see what others miss",
    threshold: 10,
    icon: '🔬',
  },
  {
    ...
    description: 'You naturally spot connections and behaviors',
    threshold: 50,
    icon: '🔗',
  },
  {
    ...
    description: 'Your analytical nature is a core strength',
    threshold: 85,
    icon: '🎯',
  },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    pattern: 'patience',
    name: 'Take Your Time',
    description: "You've discovered the power of patience",
    threshold: 10,
    icon: '⏳',
  },
  {
    ...
    pattern: 'patience',
    name: 'Deep Listening',
    description: 'You hear what others say beneath the words',
    threshold: 50,
    icon: '👂',
  },
  {
    ...
    description: 'Your thoughtfulness defines your approach',
    threshold: 85,
    icon: '⚖️',
  },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    description: 'Your questions lead to discovery',
    threshold: 10,
    icon: '🔍',
  },
  {
    ...
    description: 'You know how to dig deeper',
    threshold: 50,
    icon: '❓',
  },
  {
    ...
    description: 'Your curiosity is a guiding force',
    threshold: 85,
    icon: '🗝️',
  },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    pattern: 'helping',
    name: 'Empathy Sense',
    description: "You've attuned to others' feelings",
    threshold: 10,
    icon: '💗',
  },
  {
    ...
    description: 'People feel safe opening up to you',
    threshold: 50,
    icon: '🤝',
  },
  {
    ...
    pattern: 'helping',
    name: 'Heart to Heart',
    description: 'Your compassion runs deep',
    threshold: 85,
    icon: '💬',
  },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    description: "You've learned to see how things fit together",
    threshold: 10,
    icon: '🏗️',
  },
  {
    ...
    description: 'You know when to act, not just think',
    threshold: 50,
    icon: '⚡',
  },
  {
    ...
    description: 'You shape the world through action',
    threshold: 85,
    icon: '🎨',
  },
]
