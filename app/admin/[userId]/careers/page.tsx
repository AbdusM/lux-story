...
import { CareersSection } from '@/components/admin/sections/CareersSection'

export default function CareersPage({ params }: { params: Promise<{ userId: string }> }) {
  ...
  return <CareersSection userId={userId} profile={profile} adminViewMode={adminViewMode} />
}
