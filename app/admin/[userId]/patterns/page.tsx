...
import { PatternSection } from '@/components/admin/sections/PatternSection'
import { useAdminDashboard } from '@/components/admin/AdminDashboardContext'

export default function AdminPatternsPage({ params }: { params: Promise<{ userId: string }> }) {
  ...
  return <PatternSection userId={userId} profile={profile} adminViewMode={adminViewMode} />
}
