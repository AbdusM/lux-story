...
Copy the entire contents of `supabase/manual/auth_setup.sql` and paste it into the SQL editor, then click **Run**.
...
| File | Purpose |
|------|---------|
| `supabase/manual/auth_setup.sql` | Database schema, RLS policies, triggers |
