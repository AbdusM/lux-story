...
export function getCharacterWaitingDetail(characterId: CharacterId): string {
  const details: Record<CharacterId, string> = {
    ...
    quinn: "Quinn mentioned your talk about value. Said it was real, not performance.",
    dante: "Dante's been practicing listening more than talking. Your influence, maybe.",
    nadia: "Nadia found an ethics case she wanted to discuss with you. She's particular about who she shares with.",
    isaiah: "Isaiah's been quieter. Good quiet. Like he's processing something you helped him see.",
